...
public final class HashCodeStrongTest extends TestCase {
   ...
   public void testAdd() throws Exception {
      ...
      hashCode.add("string");
      hashCode.add(true);
      assertEquals(-1071535425, hashCode.getValue());
      assertEquals(1528643293, hashCode.getValue());
      assertEquals(hashCode.getValue(), hashCode.hashCode());
   }
   ...
   public void testHashCode() {
      ...
      assertEquals(1528643293, hashCode.hashCode());
   }
