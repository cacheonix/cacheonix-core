...
/**
 * Tester for  PassIntegerByReferenceBinary.
 */
public final class PassIntegerByValueBinaryTest extends TestCase {
    ...
    */
   private static final Logger LOG = Logger.getLogger(PassIntegerByValueBinaryTest.class); // NOPMD

   private static final Integer TEST_VALUE = 1000;

   private PassIntegerByValueBinary binary;
   ...
   public void testEquals() {
      ...
      assertEquals(new PassIntegerByValueBinary(TEST_VALUE), new PassIntegerByValueBinary(TEST_VALUE));
   }
   ...
   protected final void setUp() throws Exception {
      ...
      super.setUp();
      binary = new PassIntegerByValueBinary(TEST_VALUE);
   }


   public String toString() {

      return "PassIntegerByValueBinary{" +
              "binary=" + binary +
              "} " + super.toString();
   }
}