...
/**
 * Tester for  PassDoubleByReferenceBinary.
 */
public final class PassDoubleByValueBinaryTest extends TestCase {
    ...
    */
   private static final Logger LOG = Logger.getLogger(PassDoubleByValueBinaryTest.class); // NOPMD

   private static final Double TEST_VALUE = 1234.56;

   private PassDoubleByValueBinary binary;
   ...
   public void testEquals() {
      ...
      assertEquals(new PassDoubleByValueBinary(TEST_VALUE), new PassDoubleByValueBinary(TEST_VALUE));
   }
   ...
   protected final void setUp() throws Exception {
      ...
      super.setUp();
      binary = new PassDoubleByValueBinary(TEST_VALUE);
   }


   public String toString() {

      return "PassDoubleByReferenceBinaryTest{" +
              "binary=" + binary +
              "} " + super.toString();
   }
}