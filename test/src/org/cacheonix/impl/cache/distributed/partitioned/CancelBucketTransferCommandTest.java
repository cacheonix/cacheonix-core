...
public final class CancelBucketTransferCommandTest extends CacheonixTestCase {
    ...
    */
   private static final Logger LOG = Logger.getLogger(CancelBucketTransferCommandTest.class); // NOPMD
   ...
   protected void setUp() throws Exception {
      ...
      super.setUp();
      command = new CancelBucketTransferCommand(CACHE_NAME, SOURCE_STORAGE_NUMBER, DESTINATION_STORAGE_NUMBER, CURRENT_OWNER, NEW_OWNER);
   ...
   public String toString() {
      ...
      return "CancelBucketTransferCommandTest{" +
              "command=" + command +
              "} " + super.toString();
   }
}