 ...
 */
public final class MultiplePartitionedCacheTest extends MultiplePartitionedCacheTestCase {
    ...
    */
   private static final Logger LOG = Logger.getLogger(MultiplePartitionedCacheTest.class); // NOPMD
