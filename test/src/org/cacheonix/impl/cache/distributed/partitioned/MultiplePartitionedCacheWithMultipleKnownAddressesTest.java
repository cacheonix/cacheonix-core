 ...
 */
public final class MultiplePartitionedCacheWithMultipleKnownAddressesTest extends MultiplePartitionedCacheTestCase {
    ...
    */
   private static final Logger LOG = Logger.getLogger( // NOPMD
           MultiplePartitionedCacheWithMultipleKnownAddressesTest.class); // NOPMD

   /**
    * Cacheonix configurations, one per cluster.
    */
   private static final String[] CONFIGURATIONS = {
           "cacheonix-config-cluster-member-w-multiple-known-addresses-1.xml",
           "cacheonix-config-cluster-member-w-multiple-known-addresses-2.xml",
           "cacheonix-config-cluster-member-w-multiple-known-addresses-3.xml"
   };
