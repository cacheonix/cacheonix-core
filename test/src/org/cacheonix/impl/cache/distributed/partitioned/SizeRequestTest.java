 ...
 * @version 1.0
 */
public final class SizeRequestTest extends CacheonixTestCase {

   private static final String CACHE_NAME = "cache.name";

   private SizeRequest request = null;
   ...
   public void testDefaultConstructor() {
      ...
      final SizeRequest newMessage = new SizeRequest();
   ...
   protected void setUp() throws Exception {
      ...
      super.setUp();
      request = new SizeRequest(CACHE_NAME);
      request.setSender(TestUtils.createTestAddress());
   }
