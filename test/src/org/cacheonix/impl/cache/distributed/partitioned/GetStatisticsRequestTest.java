...
public final class GetStatisticsRequestTest extends CacheonixTestCase {
   ...
   private GetStatisticsRequest request = null;
   ...
   public void testDefaultConstructor() {
      ...
      final GetStatisticsRequest newMessage = new GetStatisticsRequest();
   ...
   protected void setUp() throws Exception {
      ...
      super.setUp();
      request = new GetStatisticsRequest(CACHE_NAME);
      request.setSender(TestUtils.createTestAddress());
   }
   ...
   public String toString() {
      ...
      return "GetStatisticsRequestTest{" +
              "request=" + request +
              '}';
   }
}