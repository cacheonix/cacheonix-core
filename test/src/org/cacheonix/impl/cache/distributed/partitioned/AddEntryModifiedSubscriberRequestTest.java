...
public final class AddEntryModifiedSubscriberRequestTest extends CacheonixTestCase {
   ...
   public void testSetSubscriber() throws Exception {
      ...
      assertSame(SUBSCRIBER, request.getLocalSubscriber());
   }
   ...
   public void testGetWireableType() {
      ...
      assertEquals(Wireable.TYPE_CACHE_ADD_ENTRY_MODIFIED_SUBSCRIBER_REQUEST, request.getWireableType());
   }
   ...
   protected void setUp() throws Exception {
      ...
      request = new AddEntryModifiedSubscriberRequest(CACHE_NAME);
