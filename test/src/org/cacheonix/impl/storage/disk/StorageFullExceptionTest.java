...
public final class StorageFullExceptionTest extends TestCase {
   ...
   public void testCreate2() {
      ...
      final StorageException storageFullException = new StorageFullException(TEST_MESSAGE, cause);
   ...
   public void testCreate3() {
      ...
      final StorageException storageFullException = new StorageFullException(cause);
      assertEquals(cause, storageFullException.getCause());
   }
}
