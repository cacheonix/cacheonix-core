...
/**
 * Tests the configuration with per-select cache enabled and per-select cache template is used.
 */
public final class MyBatisCachePerSelectCacheWithTemplateTest extends MyBatisCacheTestDriver {
   ...
   public void setUp() throws Exception {
      ...
      myBatisCache.setSelectCacheTemplateName("SelectCacheTemplate");
   }
}
