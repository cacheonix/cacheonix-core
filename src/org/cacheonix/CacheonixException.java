...
/**
 * <code>CacheonixException</code> is the superclass of those exceptions that can be thrown during the normal operation
 * of Cacheonix.
 */
public class CacheonixException extends RuntimeException {
   ...
   /**
    * Creates a new Cacheonix exception with the specified detail message. The cause is not initialized, and may
    * subsequently be initialized by a call to {@link #initCause}.
    *
    * @param message the detail message. The detail message is saved for later retrieval by the {@link #getMessage()}
    *                method.
    */
   public CacheonixException(final String message) {
   ...
   /**
    * Creates a new Cacheonix exception with the specified detail message and cause.  <p>Note that the detail message
    ...
    */
   public CacheonixException(final String message, final Throwable cause) {
   ...
   /**
    * Creates a new Cacheonix exception with the specified cause and a detail message of <tt>(cause==null ? null :
    ...
    *              value is permitted, and indicates that the cause is nonexistent or unknown.)
    */
   public CacheonixException(final Throwable cause) {

      super(ExceptionUtils.prefixWithVersion(cause.getMessage()), cause);
   }
}
