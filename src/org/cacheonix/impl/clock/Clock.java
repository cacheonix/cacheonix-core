...
public final class Clock {
    ...
    */
   private static final Logger LOG = Logger.getLogger(Clock.class); // NOPMD
   ...
   Clock(final long minimalInterProcessDelayNanos, final long jumpDetectionPeriodMillis,
   ...
   public Clock(final long minimalInterProcessDelayNanos) {
   ...
   /**
    * Adjusts the current time to the given time. This method is used when synchronize clocks. The clock is adjusted if
    * the current local time is behind. Does nothing if the parameter <code>time</code> is null.
    *
