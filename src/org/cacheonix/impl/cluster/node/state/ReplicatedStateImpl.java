 ...
 */
public final class ReplicatedStateImpl implements ReplicatedState {
    ...
    */
   private static final Logger LOG = Logger.getLogger(ReplicatedStateImpl.class); // NOPMD
    ...
    */
   private LockRegistry lockRegistry = new LockRegistryImpl();
   ...
   public void reset(final ReplicatedState newState) {
      ...
      this.groupMap = newState.getGroupMap();
      ...
      // Set lock registry
      this.lockRegistry = newState.getLockRegistry();
   }
   ...
   public Map<GroupKey, Group> getGroupMap() {
   ...
   public void readWire(final DataInputStream in) throws IOException, ClassNotFoundException {
      ...
      //
      lockRegistry = new LockRegistryImpl();
   ...
   public boolean equals(final Object obj) {
      ...
      final ReplicatedStateImpl that = (ReplicatedStateImpl) obj;
   ...
   private static final class Builder implements WireableBuilder {
      ...
      public Wireable create() {
         ...
         return new ReplicatedStateImpl();
      }
   }
}
