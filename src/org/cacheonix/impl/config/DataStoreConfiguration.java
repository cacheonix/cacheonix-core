 ...
 */
public final class DataStoreConfiguration extends DocumentReader {
   ...
   /**
    * Returns a copy of configuration properties for the cache data source.
    *
    * @return a copy of configuration properties for the cache data source.
    */
   ...
   /**
    * Returns the name of the cache data store class.
    *
    * @return the name of the cache data store class.
    */
   ...
   /**
    * Method getParam.Returns the contents of the collection in an Array.  <p>Note:  Just in case the collection
