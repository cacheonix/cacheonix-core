...
public abstract class DateLayout extends Layout {
   ...
   private String dateFormatOption = null;
   ...
   /**
    * The value of the <b>DateFormat</b> option should be either an argument to the constructor of {@link
    * SimpleDateFormat} or one of the srings "NULL", "RELATIVE", "ABSOLUTE", "DATE" or "ISO8601.
    */
   ...
   public final void dateFormat(final StringBuffer buf, final LoggingEvent event) {
      if (dateFormat != null) {
    ...
    * <p/>
    * <p>The recognized types are {@link #NULL_DATE_FORMAT}, {@link #RELATIVE_TIME_DATE_FORMAT} {@link
    * AbsoluteTimeDateFormat#ABS_TIME_DATE_FORMAT}, {@link AbsoluteTimeDateFormat#DATE_AND_TIME_DATE_FORMAT} and {@link
    * AbsoluteTimeDateFormat#ISO8601_DATE_FORMAT}. If the <code>dateFormatType</code> is not one of the above, then the
    * argument is assumed to be a date pattern for {@link SimpleDateFormat}.
    */
   public final void setDateFormat(final String dateFormatType, final TimeZone timeZone) {
