...
/**
 * <p>PatternConverter is an abtract class that provides the formatting functionality that derived classes need.
 * <p/>
...
public abstract class PatternConverter {
   ...
   public PatternConverter next = null;
   int min = -1;
   int max = 0x7FFFFFFF;
   ...
   static final String[] SPACES = {" ", "  ", "    ", "        ", //1,2,4,8 spaces
           "                ", // 16 spaces
           "                                "}; // 32 spaces
    ...
    */
   public final void spacePad(final StringBuffer sbuf, int length) {
      while (length >= 32) {
