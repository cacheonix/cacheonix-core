...
public final class Loader {
    ...
    * <ol>
    * <p/>
    * <p><li>Search for <code>resource</code> using the thread context class loader under Java2. If that fails, search
    * for <code>resource</code> using the class loader that loaded this class (<code>Loader</code>). Under JDK 1.1, only
    * the the class loader that loaded this class (<code>Loader</code>) is used.
    * <p/>
    * <p><li>Try one last time with <code>ClassLoader.getSystemResource(resource)</code>, that is is using the system
    * class loader in JDK 1.2 and virtual machine's built-in class loader in JDK 1.1.
    * <p/>
    * </ol>
    */
