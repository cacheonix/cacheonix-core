 ...
 * <p/>
 * <p>Log4j components cannot make log4j logging calls. However, it is sometimes useful for the user to learn about what
 * log4j is doing. You can enable log4j internal logging by defining the <b>log4j.configDebug</b> variable.
 * <p/>
 * <p>All log4j internal debug calls go to <code>System.out</code> where as internal error messages are sent to
...
public final class LogLog {
    ...
    */
   public
   static void debug(final String msg, final Throwable t) {
   ...
   /**
    * This method is used to output log4j internal error statements. There is no way to disable error statements. Output
    * goes to <code>System.err</code>.
    */
   public
    ...
    */
   public
   static void error(final String msg, final Throwable t) {
    ...
    *
    * @param quietMode A <code>true</code> for not
    */
   public
   static void setQuietMode(final boolean quietMode) {
    ...
    */
   public
   static void warn(final String msg, final Throwable t) {
