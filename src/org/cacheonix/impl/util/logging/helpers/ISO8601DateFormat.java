 ...
 * <p/>
 * <p>Refer to the <a href=http://www.cl.cam.ac.uk/~mgk25/iso-time.html>summary of the International Standard Date and
 * Time Notation</a> for more information on this format.
 *
 * @author Ceki G&uuml;lc&uuml;
 * @author Andrew Vajoczki
 * @since 0.7.5
 */
public final class ISO8601DateFormat extends AbsoluteTimeDateFormat {
    ...
    */
   public final StringBuffer format(final Date date, final StringBuffer sbuf,
