...
/**
 * Most of the work of the {@link PatternLayout} class is delegated to the PatternParser class.
 * <p/>
 * <p>It is this class that parses conversion patterns and creates a chained list of {@link OptionConverter
 * OptionConverters}.
 *
...
public final class PatternParser {
   ...
   public final PatternConverter parse() {
         ...
         switch (state) {
            ...
            case CONVERTER_STATE:
               ...
               switch (c) {
                  ...
                  default:
                     if (c >= '0' && c <= '9') {
                        formattingInfo.min = (int) c - (int) '0';
                        state = MIN_STATE;
                     } else {
                        finalizeConverter(c);
                     }
            ...
            case DOT_STATE:
               currentLiteral.append(c);
               if (c >= '0' && c <= '9') {
                  formattingInfo.max = (int) c - (int) '0';
                  state = MAX_STATE;
               } else {
            ...
            if (dateFormatStr.equalsIgnoreCase(
               ...
               try {
                  ...
                  df = (DateFormat) OptionConverter.instantiateByClassName(
                          "org.cacheonix.impl.util.logging.helpers.ISO8601DateFormat",
   ...
   private static final class BasicPatternConverter extends PatternConverter {
   ...
   private static final class LiteralPatternConverter extends PatternConverter {
      ...
      public
      final void format(final StringBuffer sbuf, final LoggingEvent event) {
   ...
   private static final class DatePatternConverter extends PatternConverter {
   ...
   private static final class MDCPatternConverter extends PatternConverter {
   ...
   private static final class LocationPatternConverter extends PatternConverter {
   ...
   private static final class ClassNamePatternConverter extends NamedPatternConverter {
   ...
   private static final class CategoryPatternConverter extends NamedPatternConverter {
