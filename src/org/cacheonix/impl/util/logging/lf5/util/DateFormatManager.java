...
/**
 * Date format manager. Utility class to help manage consistent date formatting and parsing. It may be advantageous to
 * have multiple DateFormatManagers per application.  For example, one for handling the output (formatting) of dates,
...
public final class DateFormatManager {
   ...
   public final synchronized DateFormat getDateFormatInstance() {
