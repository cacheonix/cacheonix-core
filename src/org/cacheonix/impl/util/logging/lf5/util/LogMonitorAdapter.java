...
public final class LogMonitorAdapter {
   ...
   //   Private Variables:
   //--------------------------------------------------------------------------
   private final LogBrokerMonitor _logMonitor;
   ...
   /**
    * <p>Creates an instance of LogMonitorAdapter using the specified LogLevels. The first LogLevel in the array is used
    * as the default LogLevel unless changed using the setDefaultLevel method.<p>
    *
   ...
   /**
    * <p>Creates an instance of LogMonitorAdapter using the specified LogLevels. The first LogLevel in the List is used
    * as the default LogLevel unless changed using the setDefaultLevel method.<p>
    *
    ...
    */
   public final void addMessage(final LogRecord record) {
   ...
   /**
    * <p>Set the default log level to be used when logging messages without specifying a LogLevel.<p>
    *
    * @param level
    */
   public final void setDefaultLevel(final LogLevel level) {
      _defaultLevel = level;
   }
    ...
    * @param level
    */
   public final void setSevereLevel(final LogLevel level) {
    ...
    * @param NDC      The NDC really only applies to Log4J and the parameter can usually be ignored.
    */
   public final void log(final String category, final LogLevel level, final String message,
                         final Throwable t, final String NDC) {
