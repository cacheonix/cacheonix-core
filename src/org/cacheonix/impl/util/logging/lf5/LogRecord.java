...
public abstract class LogRecord implements Serializable {
   ...
   /**
    * @return <code>true</code> if getThrown().toString() is a non-empty string.
    */
   public final boolean hasThrown() {

      final Throwable thrown = _thrown;
      if (thrown == null) {
         return false;
      }
   ...
   /**
    * @return <code>true</code> if isSevereLevel() or hasThrown() returns true.
    */
   ...
   /**
    * Get the event time of this record in milliseconds from 1970. When a LogRecord is constructed the event time is set
    * but may be overridden by calling setMillis();
    *
   ...
   /**
    * Set the event time of this record.  When a LogRecord is constructed the event time is set but may be overridden by
    * calling this method.
    *
   ...
   /**
    * Set the thread description associated with this LogRecord.  When a LogRecord is constructed, the thread
    * description is set by calling: Thread.currentThread().toString().  You may supply a thread description of your own
    ...
    */
   public final void setThreadDescription(final String threadDescription) {
   ...
   /**
    * Get the stack trace in a String-based format for the associated Throwable of this LogRecord. The stack trace in a
    * String-based format is set when the setThrown(Throwable) method is called. <p/> <p/> Why do we need this method
    * considering that we have the getThrown() and setThrown() methods? A Throwable object may not be serializable,
    ...
    */
   public final void setThrownStackTrace(final String trace) {
   ...
   /**
    * Set the Throwable associated with this LogRecord.  When this method is called, the stack trace in a String-based
    ...
    */
   public final void setNDC(final String ndc) {
