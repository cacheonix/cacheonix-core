 ...
 * <p/>
 * <p>For file based configuration see {@link PropertyConfigurator}. For XML based configuration see {@link
...
public final class BasicConfigurator {
   ...
   /**
    * Add a {@link ConsoleAppender} that uses {@link PatternLayout} using the {@link
    * PatternLayout#TTCC_CONVERSION_PATTERN} and prints to <code>System.out</code> to the root category.
    */
