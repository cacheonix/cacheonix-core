...
public interface Appender {
   ...
   /**
    * Returns the head Filter. The Filters are organized in a linked list and so all Filters on this
    * Appender are available through the result.
    *
   ...
   /**
    * Log in <code>Appender</code> specific way. When appropriate, Loggers will call the
    * <code>doAppend</code> method of appender implementations in order to log.
    */
