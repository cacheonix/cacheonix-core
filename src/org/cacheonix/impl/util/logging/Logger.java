...
/**
 * This is the central class in the log4j package. Most logging operations, except configuration,
...
public class Logger extends Category {
   ...
   /**
    * Retrieve a logger named according to the value of the <code>name</code> parameter. If the named
    ...
    *
    * @param clazz The name of <code>clazz</code> will be used as the name of the logger to retrieve.
    * See {@link #getLogger(String)} for more detailed information.
    */
   ...
   /**
    * Like {@link #getLogger(String)} except that the type of logger instantiated depends on the type
    * returned by the {@link LoggerFactory#makeNewLoggerInstance} method of the <code>factory</code>
    * parameter.
    * <p/>
    * <p>This method is intended to be used by sub-classes.
    *
    * @param name The name of the logger to retrieve.
    * @param factory A {@link LoggerFactory} implementation that will actually create a new
    * Instance.
    *
    * @since 0.8.5
    */
    ...
    * <p/>
    * <p/>
    * See {@link #debug(Object)} form for more detailed information. </p>
    *
    * @param message the message object to log.
    * @param t the exception to log, including its stack trace.
    *
