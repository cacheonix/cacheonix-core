...
public class HierarchyDynamicMBean extends AbstractDynamicMBean
   ...
   private final String dDescription =
           "This MBean acts as a management facade for org.cacheonix.impl.util.logging.Hierarchy.";
   ...
   public Object invoke(final String operationName,
                        final Object[] params,
   ...
   public void addAppenderEvent(final Category logger, final Appender appender) {
      ...
      final Notification n = new Notification(ADD_APPENDER + logger.getName(), this, 0L);
   ...
   public void setAttribute(final Attribute attribute) throws AttributeNotFoundException,
      ...
      if (name.equals(THRESHOLD)) {
         final Level l = OptionConverter.toLevel((String)value,
