...
final class LeaveTimeout extends ActionableTimeout {
    ...
    */
   private static final Logger LOG = Logger.getLogger(LeaveTimeout.class); // NOPMD
    ...
    * Constructor.
    *
    * @param processor a context.
    */
   LeaveTimeout(final ClusterProcessor processor) {
   ...
   protected TimeoutAction createTimeoutAction() {
      ...
      return new LeaveTimeoutAction(processor);
   }
}
