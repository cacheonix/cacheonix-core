...
public final class CacheProcessor extends RequestProcessor {
    ...
    */
   public static final int STATE_OPERATIONAL = 0;
    ...
    */
   public CacheProcessor(final Timer timer, final Clock clock, final PrefetchStage prefetchStage,
   ...
   public void removeBuckets(final byte storageNumber, final List<Integer> bucketNumbers) {
      ...
      for (int i = 0, n = bucketNumbers.size(); i < n; i++) { // NOPMD
         removeBucket(storageNumber, bucketNumbers.get(i));
      }
   }
                  ...
                  public boolean execute(final Binary key,
                     ...
                     keySubscriptions.forEach(new ObjectProcedure<EntryModifiedSubscription>() {
                        ...
                        public boolean execute(final EntryModifiedSubscription subscription) {
                           ...
                           subscriber.setProcessor(CacheProcessor.this);
