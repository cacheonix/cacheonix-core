...
public final class PassFloatByReferenceBinary implements Binary {
    ...
    */
   public PassFloatByReferenceBinary(final float object) {
   ...
   public int getWireableType() {
      ...
      return TYPE_PASS_BY_VALUE_FLOAT_BINARY;
   }
   ...
   public boolean equals(final Object o) {
      ...
      final PassFloatByReferenceBinary that = (PassFloatByReferenceBinary) o;
   ...
   public String toString() {
      ...
      return "PassFloatByReferenceBinary{" +
              "value=" + value +
              '}';
   }
