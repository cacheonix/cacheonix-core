...
/**
 * Registers XML parsers for "cacheonix" namespace.
 */
public final class CacheonixNamespaceHandler extends AbstractCacheNamespaceHandler {
    ...
    * Constructor.
    */
   public CacheonixNamespaceHandler() {
      cacheProviderFacadeParser = new CacheonixFacadeParser();
      cacheModelParser = new CacheonixModelParser();
   }
